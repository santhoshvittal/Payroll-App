          ...
          <div class="navbar navbar-inverse navbar-fixed-top">
           <div class="navbar-inner">
            <div>
             ...
             <!--  <li><a href="<?= site_url(array('user','data_fetch'));?>" >Users</a></li>
              <li><a href="<?= site_url(array('registration','add_employee'));?>" class="test">Registrations</a></li>            
              <li><a href="<?= site_url(array('salary','salary_manage'));?>" class="test">Salary Management</a></li>
              <li><a href="<?= site_url(array('calculator','calc'));?>" class="test">Calculator</a></li>   
              <li><a href="<?= site_url(array('upload','index'));?>" class="test">Upload</a></li>  -->  
            </ul>
            </div>
    ...
    <div class="row">
      <div class="span2 bs-docs-sidebar">
        <ul class="nav nav-list bs-docs-sidenav">
            <li id="color_change"><a  href="<?= site_url(array('user','data_fetch'));?>">Users</a></li>
